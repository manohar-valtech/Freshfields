...
using Valtech.Optimizely.Website.Models.Blocks;
using Valtech.Optimizely.Website.Models.Media;

namespace Valtech.Optimizely.Website.Models.Pages;
...
public class LandingPage : BasePage
{
    ...
    [Display(
        ...
        GroupName = SystemTabNames.Content,
        Order = 40)]
    [AllowedTypes(typeof(ContentBlock), typeof(ImageFile), typeof(FormContainerBlock))]
